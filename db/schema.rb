...
ActiveRecord::Schema[7.2].define(version: 2026_09_18_120000) do
  ...
  create_table "coverage_leads", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "contact_id"], name: "idx_cov_leads_account_contact"
    t.index ["account_id", "datatable_id"], name: "idx_cov_leads_account_datatable", unique: true
    t.index ["account_id", "departamento"], name: "idx_cov_leads_account_dpto"
    t.index ["account_id", "estado"], name: "idx_cov_leads_account_estado"
    t.index ["account_id", "macro_sector"], name: "idx_cov_leads_account_macro_sector"
    t.index ["account_id", "phone_number"], name: "idx_cov_leads_account_phone"
    t.index ["account_id", "user_id"], name: "idx_cov_leads_account_user"
  end
