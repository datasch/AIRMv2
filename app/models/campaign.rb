...
class Campaign < ApplicationRecord
  ...
  # TODO : enabled attribute is unnecessary . lets move that to the campaign status with additional statuses like draft, disabled etc.
  ...
  def execute_campaign
    ...
    when 'API'
      Whatsapp::GowaOneoffCampaignService.new(campaign: self).perform
    end
  end
